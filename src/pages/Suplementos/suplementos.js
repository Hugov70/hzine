...
const Suplemento5 = new Suplemento('Suplemento3', 10, 20, 'Melhor suplemento do nordeste', suplementoIcon); 
const Suplemento6 = new Suplemento('Suplemento4', 20, 0, 'Melhor suplemento do nordeste', suplementoIcon); 
